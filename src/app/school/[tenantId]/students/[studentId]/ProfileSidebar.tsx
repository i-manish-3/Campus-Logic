        ...
        <div style={{ padding: '2rem 1.5rem', textAlign: 'center' }}>
          ...
          <div style={{ textAlign: 'left' }}>
            <div style={sidebarItemStyle}>
              ...
              <span style={{ color: '#0d9488', fontWeight: '700' }}>{student.admissionNumber}</span>
            </div>
            <div style={sidebarItemStyle}>
              <span style={{ fontWeight: '700', color: '#1e293b' }}>Roll Number</span>
              <span style={{ color: '#0d9488', fontWeight: '700' }}>{student.rollNumber || '6'}</span>
            </div>
            <div style={sidebarItemStyle}>
              <span style={{ fontWeight: '700', color: '#1e293b' }}>Gender</span>
              <span style={{ color: '#0d9488', fontWeight: '700' }}>{student.gender === 'M' ? 'Male' : 'Female'}</span>
            </div>
            <div style={sidebarItemStyle}>
              <span style={{ fontWeight: '700', color: '#1e293b' }}>House</span>
              <span style={{ color: '#0d9488', fontWeight: '700' }}>{student.house || 'N/A'}</span>
            </div>
            ...
            {parent?.students?.length > 1 && (
              <div style={{ ...sidebarItemStyle, borderTop: '1px solid #f1f5f9', borderBottom: 'none', marginTop: '0.5rem', paddingTop: '0.5rem' }}>
                <span style={{ fontWeight: '700', color: '#1e293b' }}>Siblings</span>
                <span style={{ backgroundColor: '#0ea5e9', color: 'white', padding: '0.1rem 0.5rem', borderRadius: '4px', fontSize: '0.75rem', fontWeight: '800' }}>
                  {parent.students.length - 1} Registered
                </span>
              </div>
            )}
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', marginTop: '2rem' }}>
            <button style={{ backgroundColor: '#0d9488', color: 'white', border: 'none', padding: '0.75rem', borderRadius: '12px', fontWeight: '700', cursor: 'pointer', fontSize: '0.9rem' }}>
              Edit Profile
            </button>
